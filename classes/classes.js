	...
	// User1 display
	document.write("<h3>Example of user object with properties and methods</h3><p>user: " + user1.getName() + "<br>Instrument: " + user1.instrument + "<br>Age: " + user1.age + "</p><hr />");
	// User2 display 
	document.write("<h3>Example of user object enclosed in function</h3><p>user: " + user2.getName() + "<br>Instrument: " + user2.instrument + "<br>Age: " + user2.age + "</p><hr />");
	// User3 display 
	document.write("<h3>Example of user object enclosed in function</h3><p>user: " + user3.getName() + "<br>Instrument: " + user3.instrument + "<br>Age: " + user3.age + "</p>");
